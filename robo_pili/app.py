# -*- coding: utf-8 -*-
"""
Robô Comercial Pili — Tombadores e Coletores de Grãos
...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'pili-secret-2024')
...
def get_leads(limite=50):
    try:
        ...
        c.execute("""SELECT nome_fantasia, whatsapp, score, status, segmento,
                   demo_status, encontrado_em, estado
...
def api_status():
    return jsonify({'status': 'online', 'bot': 'pili', 'version': '1.0'})
